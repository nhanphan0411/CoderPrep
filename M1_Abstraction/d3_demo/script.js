...
function onValueChange() {
    document
        .querySelector("#interactive-form")
        .addEventListener("submit", (event) => {
            event.preventDefault(); //Not to perform default = reload page
            var inputValue = document.querySelector("#number").value || 47;
            render(inputValue);
            // document.querySelector(".interactive-svg").textContent = inputValue;
        });
}
